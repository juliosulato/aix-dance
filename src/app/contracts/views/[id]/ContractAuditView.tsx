...
import { ContractSignatureLog, StudentContract } from "@/types/contracts.types";
        ...
        >
          <div className="text-center mb-6">
            ...
            <Text c="dimmed">
              ...
              e <strong>{contract.student.tenancy.name}</strong>
            </Text>
          </div>
          ...
          <Divider
            my="xl"
            label="Rasto de Auditoria da Assinatura"
          ...
          {contract.signatureLogs && contract.signatureLogs.length > 0 ? (
            ...
            <Alert
              color="blue"
              title="Pendente de Assinatura"
              className="print-button"
            >
              Este contrato ainda não foi assinado. Nenhuma informação de
