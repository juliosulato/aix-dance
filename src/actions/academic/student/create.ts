...
export const createStudent = protectedAction(async (user, _prevState: ActionState<CreateStudentFormData>, formData: FormData): Promise<ActionState<CreateStudentInput>> => {
