...
export default function UpdatePaymentMethod__BasicInformations({ register, errors }: { register: UseFormRegister<UpdatePaymentMethodInput>; errors: FieldErrors<UpdatePaymentMethodInput>; }) {
