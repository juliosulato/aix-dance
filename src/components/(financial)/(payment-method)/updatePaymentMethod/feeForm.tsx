...
import { UpdatePaymentMethodInput } from "@/schemas/financial/payment-method.schema";


export default function UpdatePaymentMethod__Fees({
  control,
  register,
  errors,
}: {
  control: Control<UpdatePaymentMethodInput>;
  register: UseFormRegister<UpdatePaymentMethodInput>;
  errors: FieldErrors<UpdatePaymentMethodInput>;
}) {
