...
import { UpdateBankInput } from "@/schemas/financial/bank.schema";
...
const initialState: ActionState<UpdateBankInput> = {
  errors: {
    name: undefined,
    code: undefined,
    agency: undefined,
...
export default function UpdateBankAccount({
  ...
  const [state, formAction, pending] = useActionState(updateBank, initialState);
  ...
  const [formValues, setFormValues] = useState({
    ...
    maintenanceFeeAmount: bankAccount?.maintenanceFeeAmount?.toNumber() || undefined,
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <NumberInput
              ...
              onChange={(val) =>
                setFormValues({
                  ...formValues,
                  maintenanceFeeAmount: val === undefined ? undefined : Number(val),
                })
              }
            />
            ...
            <NumberInput
              ...
              onChange={(val) =>
                setFormValues({
                  ...formValues,
                  maintenanceFeeDue: val === undefined || val === null || val === "" ? undefined : Number(val),
                })
              }
            />
