    ...
    return (
        <>
            ...
            <Controller
                ...
                defaultValue=""
                render={({ field }) => {
                    // Atualiza o editor quando field.value muda externamente
                    useEffect(() => {
                        if (!editor) return;
                    ...
                    // Atualiza o form quando o usuário edita o editor
                    useEffect(() => {
                        if (!editor) return;
                        const handleUpdate = () => {
